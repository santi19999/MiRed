...
while opcion != 0:
    ...
    if opcion == 1:
        ...
        nombre_muro_amigo = input("Ingresa el nombre de tu amigo, para ver sus ultimas publicaciones: ")
        if Red.existe_archivo(nombre_muro_amigo+".user"):
            (nombre, edad, estatura_m, estatura_cm, sexo, pais, amigos, estado, muro_amigo) = Red.leer_usuario(nombre_muro_amigo)
            Red.mostrar_muro(muro_amigo)
...
#   de parte del destinatario, de manera que la relación de amistad puede perfectamente existir en un solo sentido.(listo)
#
